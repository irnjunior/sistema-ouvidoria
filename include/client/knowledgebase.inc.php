	...
	<div class="row"> 
		...
		<div class="col-sm-4">
			<div class="form-group">  
				<input class="form-control" id="query" type="text" size="20" name="q" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" placeholder="<?php echo __('Keyword Search');?>">
			</div>
    		<!-- /.form-group -->
		</div>
		<!-- /.col -->
	...
	<div class="col-xs-12">
		...
		if($_REQUEST['q'] || $_REQUEST['cid'] || $_REQUEST['topicId']) { //Search.
		    ...
		    if(($res=db_query($sql)) && ($num=db_num_rows($res))) {
		        ...
		        while($row=db_fetch_array($res)) {
		            echo sprintf('
		                <li class="list-group-item"><i class="fa fa-file-text-o"></i>  <a href="faq.php?id=%d" class="previewfaq">%s</a></li>',
		                ...
		                <div class="panel panel-success">
		                    <div class="panel-heading">
		                    	<h2 class="panel-title"> 
		                    		<a href="faq.php?cid=%d">%s </a><span>(%d)</span>
		                    		<div class="btn-group pull-right"><a data-toggle="collapse" href="#collapse'.$i.'" class="collapsed"><i class="fa fa-info-circle text-success"></i> <i class="fa fa-chevron-up text-success"></i></a></div>
		                    	</h2>
		                    </div>
